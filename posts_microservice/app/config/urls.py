...
urlpatterns = [
    ...
    path(
        "api/category/<int:pk>/", CategoryUpdateView.as_view(), name="category-update"
    ),
    ...
    path(
        "api/post/from-user/<int:user_id>/",
        PostsFromUserView.as_view(),
        name="user-posts",
    ),
    path("api/post/favorite/", FavoriteView.as_view(), name="favorite-toggle"),
    path(
        "api/post/favorite/<int:user_id>/",
        FavoritePostsView.as_view(),
        name="favorite-posts",
    ),
    path(
        "api/post/u-favorite/<int:user_id>/",
