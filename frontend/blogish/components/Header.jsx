...
const Header = ({ active, handleClosePopup }) => {
  // const token = null;
  // useSelector((state) => state.global.data.token);
    ...
    <>
      <div className="header">
        <div className="container-header">
          ...
          <div className={true ? 'header-right-login' : 'header-right'}>
            ...
            <Image width={35} height={35} src="./images/bell.svg" />
              ...
              <>
                ...
                <Image onClick={handleClosePopup} src="./images/logout.svg" width={35} height={35} />{' '}
                <p
